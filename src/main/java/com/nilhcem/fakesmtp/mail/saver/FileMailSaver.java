 ...
 * @since 1.0
 */
public final class FileMailSaver extends Observable implements MailSaver
{
	private static final Logger LOGGER = LoggerFactory.getLogger(FileMailSaver.class);
  ...
  public void deleteEmails() {
	 ...
	 * </p>
	 *
	 * @return a lock object <i>(which is actually the current instance of the {@code FileMailSaver} object)</i>.
	 */
	@Override
